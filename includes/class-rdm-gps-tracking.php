...
class RDM_GPS_Tracking {
    ...
    /**
     * Main GPS Tracking Instance
     *
     * @return RDM_GPS_Tracking
     */
    public static function instance(): RDM_GPS_Tracking {
     ...
     * @return RDM_GPS_Tracking
     */
    public static function get_instance(): RDM_GPS_Tracking {
        return self::instance();
    }
    ...
    public function calculate_distance($lat1, $lon1, $lat2, $lon2) {
        return RDM_Location_Utilities::calculate_haversine_distance($lat1, $lon1, $lat2, $lon2);
    }
